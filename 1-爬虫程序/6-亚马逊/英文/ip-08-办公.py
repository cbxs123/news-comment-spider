...
def log(ma):
    file = open(r'08-办公.txt', mode='a+', encoding='utf-8')
    file.write(ma+'\n')
    file.close()
            ...
            try:
                ...
                try:
                    with connection.cursor() as cursor:
                        sql = " insert into `amazon_cn_08bangong`(`proid`,`prourl`,`goodRateShow`,`commentCount`," \
...
if __name__ == "__main__":
    for k in range(1,400):
        ...
        print(ma)
        log(ma)
        url="https://www.amazon.cn/s/ref=sr_pg_"+str(k)+"?rh=n%3A2127221051%2Ck%3A%E5%8A%9E%E5%85%AC%E7%94%A8%E5%93%81&page="+str(k)+"&sort=review-rank&keywords=%E5%8A%9E%E5%85%AC%E7%94%A8%E5%93%81&ie=UTF8&lo=office-products"
