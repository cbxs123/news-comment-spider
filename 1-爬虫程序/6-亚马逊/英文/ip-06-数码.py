...
def log(ma):
    file = open(r'06-数码.txt', mode='a+', encoding='utf-8')
    file.write(ma+'\n')
    file.close()
            ...
            try:
                ...
                try:
                    with connection.cursor() as cursor:
                        sql = " insert into `amazon_cn_06shuma`(`proid`,`prourl`,`goodRateShow`,`commentCount`," \
...
if __name__ == "__main__":
    for k in range(1,400):
        ...
        print(ma)
        log(ma)
        url="https://www.amazon.cn/s/ref=sr_pg_"+str(k)+"?sf=sbc%2Cqz&rh=n%3A760233051%2Ck%3A%E6%95%B0%E7%A0%81&page="+str(k)+"&sort=review-rank&keywords=%E6%95%B0%E7%A0%81&ie=UTF8&lo=music-players"
