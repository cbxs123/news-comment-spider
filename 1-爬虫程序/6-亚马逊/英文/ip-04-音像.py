...
def log(ma):
    file = open(r'04-音像.txt', mode='a+', encoding='utf-8')
    file.write(ma+'\n')
    file.close()
            ...
            try:
                ...
                try:
                    with connection.cursor() as cursor:
                        sql = " insert into `amazon_cn_04yinxiang`(`proid`,`prourl`,`goodRateShow`,`commentCount`," \
...
if __name__ == "__main__":
    for k in range(1,400):
        ...
        print(ma)
        log(ma)
        url = "https://www.amazon.cn/s/ref=sr_pg_" + str(k) + "?rh=n%3A2016136051%2Ck%3A%E9%9F%B3%E5%83%8F&page=" + str(k) + "&sort=review-rank&keywords=%E9%9F%B3%E5%83%8F&ie=UTF8&lo=video"
