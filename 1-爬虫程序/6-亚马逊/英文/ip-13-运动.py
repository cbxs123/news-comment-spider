...
def log(ma):
    file = open(r'13_运动.txt', mode='a+', encoding='utf-8')
    file.write(ma+'\n')
    file.close()
            ...
            try:
                ...
                try:
                    with connection.cursor() as cursor:
                        sql = " insert into `amazon_cn_13yundong`(`proid`,`prourl`,`goodRateShow`,`commentCount`," \
...
if __name__ == "__main__":
    for k in range(54,400):
        ...
        print(ma)
        log(ma)
        url="https://www.amazon.cn/s/ref=sr_pg_"+str(k)+"?rh=n%3A836312051%2Ck%3A%E8%BF%90%E5%8A%A8%E6%88%B7%E5%A4%96%E4%BC%91%E9%97%B2&page="+str(k)+"&sort=review-rank&keywords=%E8%BF%90%E5%8A%A8%E6%88%B7%E5%A4%96%E4%BC%91%E9%97%B2&ie=UTF8&lo=sporting"
