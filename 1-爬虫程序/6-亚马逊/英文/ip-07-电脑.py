...
def log(ma):
    file = open(r'07-电脑.txt', mode='a+', encoding='utf-8')
    file.write(ma+'\n')
    file.close()
            ...
            try:
                ...
                try:
                    with connection.cursor() as cursor:
                        sql = " insert into `amazon_cn_07diannao`(`proid`,`prourl`,`goodRateShow`,`commentCount`," \
...
if __name__ == "__main__":
    for k in range(1,400):
        ...
        print(ma)
        log(ma)
        url="https://www.amazon.cn/s/ref=sr_pg_"+str(k)+"?rh=n%3A42689071%2Ck%3A%E7%94%B5%E8%84%91&page="+str(k)+"&sort=review-rank&keywords=%E7%94%B5%E8%84%91&ie=UTF8&lo=computers"
