...
def log(ma):
    file = open(r'01-汽车.txt', mode='a+', encoding='utf-8')
    file.write(ma+'\n')
    file.close()
            ...
            try:
                ...
                try:
                    with connection.cursor() as cursor:
                        sql = " insert into `amazon_cn_01qiche`(`proid`,`prourl`,`goodRateShow`,`commentCount`," \
...
if __name__ == "__main__":
    for k in range(1,400):
        ...
        print(ma)
        log(ma)
        url = "https://www.amazon.cn/s/ref=sr_pg_" + str(k) + "?rh=n%3A1947899051%2Ck%3A%E6%B1%BD%E8%BD%A6%E7%94%A8%E5%93%81&page=" + str(k) + "&sort=review-rank&keywords=%E6%B1%BD%E8%BD%A6%E7%94%A8%E5%93%81&ie=UTF8"
