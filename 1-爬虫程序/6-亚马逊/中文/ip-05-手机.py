...
def log(ma):
    file = open(r'05-手机.txt', mode='a+', encoding='utf-8')
    file.write(ma+'\n')
    file.close()
            ...
            try:
                ...
                try:
                    with connection.cursor() as cursor:
                        sql = " insert into `amazon_cn_05shouji`(`proid`,`prourl`,`goodRateShow`,`commentCount`," \
...
if __name__ == "__main__":
    for k in range(1,400):
        ...
        print(ma)
        log(ma)
        url="https://www.amazon.cn/s/ref=sr_pg_"+str(k)+"?sf=sbc%2Cqz&rh=n%3A664978051%2Ck%3A%E6%89%8B%E6%9C%BA&page="+str(k)+"&sort=review-rank&keywords=%E6%89%8B%E6%9C%BA&ie=UTF8&lo=communications"
