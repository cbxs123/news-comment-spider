...
def log(ma):
    file = open(r'10_家居.txt', mode='a+', encoding='utf-8')
    file.write(ma+'\n')
    file.close()
            ...
            try:
                ...
                try:
                    with connection.cursor() as cursor:
                        sql = " insert into `amazon_cn_10jiaju`(`proid`,`prourl`,`goodRateShow`,`commentCount`," \
...
if __name__ == "__main__":
    for k in range(1,400):
        ...
        print(ma)
        log(ma)
        url="https://www.amazon.cn/s/ref=sr_pg_"+str(k)+"?rh=n%3A1952920051%2Ck%3A%E5%AE%B6%E5%B1%85&page="+str(k)+"&sort=review-rank&keywords=%E5%AE%B6%E5%B1%85&ie=UTF8&lo=home-improvement"
