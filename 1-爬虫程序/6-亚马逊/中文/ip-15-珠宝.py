...
def log(ma):
    file = open(r'15_zhubao.txt', mode='a+', encoding='utf-8')
    file.write(ma+'\n')
    file.close()
            ...
            try:
                ...
                try:
                    with connection.cursor() as cursor:
                        sql = " insert into `amazon_cn_15zhubao`(`proid`,`prourl`,`goodRateShow`,`commentCount`," \
...
if __name__ == "__main__":
    for k in range(50,400):
        ...
        print(ma)
        log(ma)
        url="https://www.amazon.cn/s/ref=sr_pg_"+str(k)+"?rh=n%3A816482051%2Ck%3A%E7%8F%A0%E5%AE%9D%E9%A6%96%E9%A5%B0&page="+str(k)+"&sort=review-rank&keywords=%E7%8F%A0%E5%AE%9D%E9%A6%96%E9%A5%B0&ie=UTF8&lo=mi"
