...
if __name__ == "__main__":
    for k in range(127,400):
        ...
        print(ma)
        log(ma)
        url="https://www.amazon.cn/s/ref=sr_pg_"+str(k)+"?sf=sbc%2Cqz&rh=n%3A1953164051%2Ck%3A%E9%92%9F%E8%A1%A8&page="+str(k)+"&sort=review-rank&keywords=%E9%92%9F%E8%A1%A8&ie=UTF8"
