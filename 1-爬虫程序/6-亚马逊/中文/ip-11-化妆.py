...
def log(ma):
    file = open(r'11_化妆.txt', mode='a+', encoding='utf-8')
    file.write(ma+'\n')
    file.close()
            ...
            try:
                ...
                try:
                    with connection.cursor() as cursor:
                        sql = " insert into `amazon_cn_11huazhuang`(`proid`,`prourl`,`goodRateShow`,`commentCount`," \
...
if __name__ == "__main__":
    for k in range(19,400):
        ...
        print(ma)
        log(ma)
        url="https://www.amazon.cn/s/ref=sr_pg_"+str(k)+"?rh=n%3A746776051%2Ck%3A%E5%8C%96%E5%A6%86&page="+str(k)+"&sort=review-rank&keywords=%E5%8C%96%E5%A6%86&ie=UTF8&lo=beauty"
