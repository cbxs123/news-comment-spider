...
def log(ma):
    file = open(r'新浪-一带一路.txt', mode='a+', encoding='utf-8')
    file.write(ma+'\n')
    file.close()
...
def foo1(u):
    ...
    def get1():
        url1 = 'http://search.sina.com.cn/?c=news&q=%D2%BB%B4%F8%D2%BB%C2%B7&range=all&time=custom&stime=' + str(
    ...
    if w==1:
        for m in r:
            try:
                url = 'http://search.sina.com.cn/?c=news&q=%D2%BB%B4%F8%D2%BB%C2%B7&range=all&time=custom&stime=' + str(
...
if __name__ == "__main__":
    ...
    if g==1:
        w,p,q,n,s,e=1,20,30,20,'2015-03-28','2018-10-31'
    else:
