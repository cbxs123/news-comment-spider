...
for k in range(0,20):
    ...
    url="https://search.jd.com/Search?keyword=%E6%89%8B%E6%9C%BA&enc=utf-8&qrst=1&rt=1&stop=1&vt=2&suggest=1.def.0.V00&wq=shouji&psort=4&cid2=653&cid3=655&page="+str(2*k+1)
                            ...
                            for com in coms:
                                ...
                                try:
                                    with connection.cursor() as cursor:
                                        sql = " insert into `jd_180828_sj`(`proid`,`prourl`,`proprice`,`goodRateShow`,`commentCount`," \
