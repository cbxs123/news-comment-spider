...
for k in range(0,20):
    ...
    url="https://search.jd.com/Search?keyword=%E8%BF%90%E5%8A%A8&enc=utf-8&qrst=1&rt=1&stop=1&vt=2&wq=%E8%BF%90%E5%8A%A8&psort=4&page="+str(2*k+1)
                            ...
                            for com in coms:
                                ...
                                try:
                                    with connection.cursor() as cursor:
                                        sql = " insert into `jd_180831_yundong`(`proid`,`prourl`,`proprice`,`goodRateShow`,`commentCount`," \
