...
# 京东服饰内衣信息采集：商品ID、价格、整体好评度、总评论数、晒图、追评、好评、中评、差评、
#               评论者ID、评论、星级、赞、回复数等
...
for k in range(0,20):
    ...
    url="https://search.jd.com/Search?keyword=%E6%9C%8D%E9%A5%B0%E5%86%85%E8%A1%A3&enc=utf-8&qrst=1&rt=1&stop=1&vt=2&wq=%E6%9C%8D%E9%A5%B0%E5%86%85%E8%A1%A3&psort=4&page="+str(2*k+1)
                            ...
                            for com in coms:
                                ...
                                try:
                                    with connection.cursor() as cursor:
                                        sql = " insert into `jd_180831_fushi`(`proid`,`prourl`,`proprice`,`goodRateShow`,`commentCount`," \
