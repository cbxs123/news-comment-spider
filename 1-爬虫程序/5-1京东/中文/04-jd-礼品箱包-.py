...
# 京东礼品箱包信息采集：商品ID、价格、整体好评度、总评论数、晒图、追评、好评、中评、差评、
#               评论者ID、评论、星级、赞、回复数等
...
for k in range(0,20):
    ...
    url="https://search.jd.com/Search?keyword=%E7%A4%BC%E5%93%81%E7%AE%B1%E5%8C%85&enc=utf-8&qrst=1&rt=1&stop=1&vt=2&wq=%E7%A4%BC%E5%93%81%E7%AE%B1%E5%8C%85&psort=4&page="+str(2*k+1)
                            ...
                            for com in coms:
                                ...
                                try:
                                    with connection.cursor() as cursor:
                                        sql = " insert into `jd_180831_lpxb`(`proid`,`prourl`,`proprice`,`goodRateShow`,`commentCount`," \
