...
# 京东家用电器信息采集：商品ID、价格、整体好评度、总评论数、晒图、追评、好评、中评、差评、
#               评论者ID、评论、星级、赞、回复数等
...
for k in range(0,20):
    ...
    url="https://search.jd.com/Search?keyword=%E5%AE%B6%E7%94%A8%E7%94%B5%E5%99%A8&enc=utf-8&qrst=1&rt=1&stop=1&vt=2&wq=%E5%AE%B6%E7%94%A8%E7%94%B5%E5%99%A8&psort=4&stock=1&page="+str(2*k+1)
        ...
        for j in range(len(sku)):
            try:
                ...
                try:
                            ...
                            for com in coms:
                                ...
                                try:
                                    with connection.cursor() as cursor:
                                        sql = " insert into `jd_180831_jydq`(`proid`,`prourl`,`proprice`,`goodRateShow`,`commentCount`," \
                    ...
                    print('008---出错:' + str(k) + '页-' + str(j) + ':' + str(sku[j]) + '商品-' + str(i) + '页评论-' + str(vvid))
                    pass
            except:
