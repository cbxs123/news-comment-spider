...
def log(ma):
    file = open(r'新浪-英国脱欧.txt', mode='a+', encoding='utf-8')
    file.write(ma+'\n')
    file.close()
...
def foo1(u):
    ...
    def get1():
        url1 = 'http://search.sina.com.cn/?c=news&q=%D3%A2%B9%FA%CD%D1%C5%B7&range=all&time=custom&stime=' + str(
    ...
    if w==1:
        for m in r:
            try:
                url = 'http://search.sina.com.cn/?c=news&q=%D3%A2%B9%FA%CD%D1%C5%B7&range=all&time=custom&stime=' + str(
...
if __name__ == "__main__":
    ...
    if g==1:
        w,p,q,n,s,e=1,20,60,20,'2013-01-23','2018-10-30'
    else:
